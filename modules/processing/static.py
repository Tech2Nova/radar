        ...
        for entry in getattr(self.pe, "DIRECTORY_ENTRY_IMPORT", []):
            try:
                ...
                for imported_symbol in entry.imports:
                    ...
                    if isinstance(imported_symbol.name, bytes):
...
class Static(Processing):
    ...
    def _get_keys(self):
        ...
        buf = open(self.file_path, 'rb').read()
        buf = buf.decode('utf-8', 'ignore')  # replace 'utf-8' with the correct encoding if necessary
