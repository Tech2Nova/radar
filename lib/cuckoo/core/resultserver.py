...
class ResultServer(socketserver.ThreadingTCPServer, object, metaclass=Singleton):
        ...
        while True:
            try:
                ...
                if e.errno == errno.EADDRINUSE:
                    ...
                    raise CuckooCriticalError(f"Unable to bind ResultServer on {ip}:{self.port}: {e}")
